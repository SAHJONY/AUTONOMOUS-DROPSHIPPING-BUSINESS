...
export const BOTANICA_SUPPLIERS: BotanicaSupplier[] = [
  ...
  {
    id: "lazaro-brand-wholesale",
    name: "Lazaro Brand Spiritual Supply",
    region: "USA",
    location: "United States / online wholesale",
    website: "https://lazarobrand.com/wholesale",
    wholesale: true,
    status: "REQUIRES_ACCOUNT",
    categories: ["ritual candles", "spiritual oils", "incense", "bracelets", "botanica consumables"],
    strengths: ["states it manufactures its own brand", "private-label offered", "bulk ritual supplies", "also resells Indio Products lines"],
    sourceEvidence: ["https://lazarobrand.com/wholesale", "https://lazarobrand.com/indio-products/"],
    sourcingPolicy: "CUSTOM_MANUFACTURING",
    secondarySourcingPolicies: ["CONSUMABLES"],
    researchPriority: 1
  },
  {
    id: "lucky-mojo-curio",
    name: "Lucky Mojo Curio Co.",
    region: "USA",
    location: "Forestville, California",
    website: "https://www.luckymojo.com/wholesale.html",
    wholesale: true,
    status: "REQUIRES_ACCOUNT",
    categories: ["conjure oils", "sachet powders", "incense", "curios", "spiritual supplies"],
    strengths: ["describes itself as manufacturer and importer", "published wholesale terms (minimum 3 packs per title at 50% of retail)"],
    sourceEvidence: ["https://www.luckymojo.com/wholesale.html"],
    sourcingPolicy: "CONSUMABLES",
    researchPriority: 2
  },
  {
    ...
    wholesale: false,
    status: "REQUIRES_CONTACT",
    categories: ["magical oils", "sachet powders", "ritual baths", "incense", "soaps", "candles"],
    strengths: ["own workshop since 1999", "states products are handmade in-house", "small-batch maker rather than reseller"],
    sourceEvidence: ["https://www.aromags.com/"],
    sourcingPolicy: "CONSUMABLES",
    researchPriority: 2
  },
  {
    id: "original-botanica-bronx",
    name: "Original Botanica",
    region: "USA",
    location: "Bronx, New York",
    website: "https://originalbotanica.com/wholesale-botanica-products",
    wholesale: true,
    status: "REQUIRES_ACCOUNT",
    categories: ["Santeria and Ifa supplies", "ritual candles", "spiritual oils", "herbs", "espiritismo goods"],
    strengths: ["trading since 1959", "published wholesale partner application", "deep Santeria/Ifa assortment"],
    sourceEvidence: ["https://originalbotanica.com/wholesale-botanica-products", "https://originalbotanica.com/santeria-ifa-supplies/"],
    sourcingPolicy: "CORE_RELIGIOUS",
    secondarySourcingPolicies: ["CONSUMABLES"],
    researchPriority: 1
  },
  {
    id: "golden-owl-warehouse",
    name: "Golden Owl Warehouse",
    region: "USA",
    location: "United States / import wholesale",
    website: "https://goldenowlwarehouse.com/",
    wholesale: true,
    status: "REQUIRES_ACCOUNT",
    categories: ["botanica goods", "hoodoo supplies", "multicultural spiritual items"],
    strengths: ["importer and wholesaler", "catalog released on seller-permit verification"],
    sourceEvidence: ["https://goldenowlwarehouse.com/"],
    sourcingPolicy: "CONSUMABLES",
    researchPriority: 2
  },
  {
    id: "nu-botanics-supply",
    name: "Nu-Botanics",
    region: "USA",
    ...
    wholesale: true,
    status: "REQUIRES_ACCOUNT",
    categories: ["Santeria supplies", "occult goods", "seven-day candles", "botanica consumables"],
    strengths: ["distributor across religious and occult lines", "seven-day fixed candle range"],
    sourceEvidence: ["https://www.nu-botanics.com/", "https://www.nu-botanics.com/category/seven-day-fixed-velas-misticas/482"],
    sourcingPolicy: "CONSUMABLES",
    researchPriority: 2
  },
  {
    id: "botanica-supply-wholesale",
    name: "Botanica Supply",
    region: "USA",
    location: "United States / online wholesale",
    website: "https://botanica.supply/",
    wholesale: true,
    status: "REQUIRES_ACCOUNT",
    categories: ["botanica products", "religious goods", "spiritual supplies"],
    strengths: ["wholesale-first storefront"],
    sourceEvidence: ["https://botanica.supply/"],
    sourcingPolicy: "CONSUMABLES",
    researchPriority: 3
  },
  {
    id: "original-publications-occult1",
    name: "Original Publications (Occult1)",
    region: "USA",
    location: "United States",
    website: "https://www.occult1.com/",
    wholesale: true,
    status: "REQUIRES_ACCOUNT",
    categories: ["spiritual soaps", "conjure oils", "religious books", "occult supplies"],
    strengths: ["long-standing publisher and producer of botanica lines", "spiritual soap range"],
    sourceEvidence: ["https://www.occult1.com/", "https://www.occult1.com/spiritual-soaps.html"],
    sourcingPolicy: "CONSUMABLES",
    researchPriority: 3
  },
  {
    id: "botanica-online-candles",
    name: "Botanica Online",
    region: "USA",
    location: "United States / online",
    website: "https://botanicaonline.net/pages/wholesale-candles",
    wholesale: true,
    status: "REQUIRES_ACCOUNT",
    categories: ["wholesale candles", "veladoras", "botanica consumables"],
    strengths: ["published wholesale candle programme"],
    sourceEvidence: ["https://botanicaonline.net/pages/wholesale-candles"],
    sourcingPolicy: "CONSUMABLES",
    researchPriority: 3
  },
  {
