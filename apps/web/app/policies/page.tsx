...
export default function PoliciesPage() {
  return <main className={styles.shell}>
    ...
    <div className={styles.content}>
      ...
      <section id="contacto"><span>05</span><div><h2>Contacto por departamento</h2><p>Para pedidos, envíos, daños o devoluciones, escribe al <a href={`mailto:${BOTANICA_CONTACT_EMAILS.orders}?subject=Ayuda%20con%20mi%20pedido`}>Departamento de Pedidos</a>. Incluye el número de pedido, pero nunca datos completos de tarjeta o contraseñas.</p><p>Para solicitudes sobre tus datos, escribe a <a href={`mailto:${BOTANICA_CONTACT_EMAILS.privacy}?subject=Solicitud%20de%20privacidad`}>Privacidad</a>. Para cualquier otra pregunta, contacta a <a href={`mailto:${BOTANICA_CONTACT_EMAILS.support}?subject=Soporte%20BOTANICA%20OCHOSI`}>Soporte al Cliente</a>.</p><p className={styles.note}>Todos los departamentos son atendidos directamente desde la cuenta oficial de BOTANICA OCHOSI.</p></div></section>
    </div>
