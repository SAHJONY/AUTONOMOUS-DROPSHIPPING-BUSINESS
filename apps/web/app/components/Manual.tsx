  ...
  return (
    <main className="doc">
      ...
      <section id="guardrails" className="doc-section">
        ...
        <div className="doc-note"><b>El dinero real tiene un límite propio.</b> Una orden autónoma al proveedor no puede comprometer más de <code>$100</code>. El límite <code>AUTOPILOT_MAX_ORDER_COST</code> puede reducirse, pero nunca elevarse por encima de $100; cualquier orden mayor espera aprobación explícita del Owner. Una orden tampoco se compra dos veces: los reintentos reconocen si ya fue emitida.</div>
